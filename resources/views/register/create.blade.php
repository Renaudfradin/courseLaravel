<x-layout>
    <form action="/register" method="post">
        ...
        <input type="text" name="name" id="name" class="border-2 border-solid border-black-500">
        @error('name')
            <p>{{ $message}}</p>
        @enderror

        <label for="username">username</label>
        <input type="text" name="username" id="username" class="border-2 border-solid border-black-500">
        @error('username')
            <p>{{ $message}}</p>
        @enderror
